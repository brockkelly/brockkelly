...
The triangulararbitrage() function takes an input of a pair of currencies and calculates the profit from all possible triangular arbitrage trades from a list of 14 currencies.

Future improvements include testing with higher frequency (minute by minute) data, the addition of trading costs, and the account of time differential to account for order processing.

Currency tickers can be found here: https://docs.intrinio.com/documentation/download/currencies
...
# importing csv file of currencies
...
Choose a currency pair ex. CAD/USD
